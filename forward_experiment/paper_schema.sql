...
-- schema versions
[(2, 'forward paper operations'), (3, 'forward baseline and monthly benchmark alignment'), (4, 'experiment-scoped windows and incidents'), (5, 'versioned ask-bid execution context'), (6, 'final executable order quantity ledger semantics'), (7, 'explicit preservation of pre-adoption ledger semantics'), (8, 'persist proposal and final execution rejection diagnostics'), (9, 'persist run-attributable paper order rejection audit trail'), (10, 'atomically persist forward execution evidence'), (11, 'explicit execution outcomes and post-execution deviation audit'), (12, 'quote coherence provenance and legacy v5 normalization'), (13, 'per-forward-run release provenance'), (14, 'retryable forward admission attempt schedule identity')]
